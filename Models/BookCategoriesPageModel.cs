...
namespace Dumitriu_Constantin_Lab2.Models

{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Dumitriu_Constantin_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Dumitriu_Constantin_Lab2Context context,
